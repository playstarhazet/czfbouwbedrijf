document.addEventListener('DOMContentLoaded', function() {
    ...
    function createGalleryItem(folder, imagePath, index, total) {
        ...
        img.src = `assets/images/${folder}/${imagePath}`;
    ...
    function openLightbox(folder, imagePath, currentIndex, allImages) {
        ...
        function updateImage(newIndex) {
            img.src = `assets/images/${folder}/${allImages[newIndex]}`;
    ...
    document.querySelectorAll('nav a, .hero-cta').forEach(anchor => {
        anchor.addEventListener('click', function(e) {
            ...
            // Oblicz dokładną pozycję przewijania
            const targetPosition = targetSection.getBoundingClientRect().top + window.pageYOffset;
            const offsetPosition = targetPosition - header.offsetHeight;
